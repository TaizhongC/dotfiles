...
local menu        = "sh -c 'command -v wofi >/dev/null 2>&1 || exit 0; pgrep -x wofi >/dev/null 2>&1 && pkill -x wofi || exec wofi --show drun --fork --style /home/tc/.config/wofi/style.css'"
...
-- Screenshots: Print selects an area; Shift+Print captures the full output.
